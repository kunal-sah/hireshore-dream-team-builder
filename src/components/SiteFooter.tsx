...
const SiteFooter = () => (
  <footer className="w-full py-12 md:py-16 bg-gradient-to-t from-[#e7e9f9] to-transparent mt-8 md:mt-12">
    <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-6 items-start justify-between px-6 md:px-8">
    ...
    <div className="text-xs text-center text-gray-400 pt-8 mt-6 border-t border-gray-100 max-w-4xl mx-auto">© {new Date().getFullYear()} Hireshore. All rights reserved.</div>
  </footer>
);
