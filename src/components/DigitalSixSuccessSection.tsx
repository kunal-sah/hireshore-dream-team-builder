      ...
      >
        ...
        >
          <div className="bg-white rounded-xl px-8 py-4 shadow-lg border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-900">Digital Six</h3>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center">
            <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden w-full max-w-2xl mx-auto">
              <iframe
...
export default DigitalSixSuccessSection;