...
import Index from "./pages/Index"; // Keep homepage as eager load for LCP
...
// Lazy load guides (major contributors to unused JS)
...
// Lazy load case notes (major contributors to unused JS)
